USE [master]
GO
/****** Object:  Database [ExampleDatabase]    Script Date: 14.7.2021 г. 9:58:31 ******/
CREATE DATABASE [ExampleDatabase]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ExampleDatabase', FILENAME = N'C:\Users\Owner\ExampleDatabase.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ExampleDatabase_log', FILENAME = N'C:\Users\Owner\ExampleDatabase_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
USE [ExampleDatabase]
GO
/****** Object:  Table [dbo].[Cars]    Script Date: 14.7.2021 г. 9:58:31 ******/
SET ANSI_NULLS ON
GO
